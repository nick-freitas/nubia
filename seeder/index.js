        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // Register the main admin user
                    _a.sent();
                    config.users.forEach(function (user) { return __awaiter(_this, void 0, void 0, function () {
                        var _a, access_token, adminUserId;
                        var _this = this;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    _a = (_b.sent()).data, access_token = _a.access_token, adminUserId = _a.id;
...
main()
    .then(function () { return console.info("Complete"); })["catch"](function (err) { return console.error(err); });
